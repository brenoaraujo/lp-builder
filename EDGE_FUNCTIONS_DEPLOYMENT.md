...
Since the CLI linking isn't working, we'll deploy the functions manually through the Supabase dashboard.

## 🚀 **Deploy Function 1: `drafts`**
...
async function getDraft(draftId: string, req: Request) {
  // Simple auth check - in production, implement proper token validation
...
2. Go to `#/onboarding` 
3. Complete the onboarding to create a draft
4. Check if the draft creation works

Let me know when you've deployed the functions and we can test the system!
